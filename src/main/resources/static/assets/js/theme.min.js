...
!function () {
    ...
    e.length && e.forEach((function (e) {
        ...
        e.addEventListener("click", (function (e) {
            e.target.classList.contains("button-plus") ? function (e) {
                e.preventDefault();
                var t = e.target, n = t.getAttribute("data-field"),
                    o = t.closest("div").querySelector('input[name="' + n + '"]'), a = parseInt(o.value, 10) || 0;
                o.value = a + 1
    ...
    t.length && t.forEach((function (e) {
        ...
        raterJs({
            starSize: 20, element: e, rateCallback: function (e, t) {
                this.setRating(e), t()
            }
        })
    }));
    ...
    u.length && u.forEach((function (e) {
        e.addEventListener("change", (function () {
            var t = e.parentElement.parentElement.querySelector(".image"), n = new FileReader;
            n.onload = function (e) {
